...
const doNotDelete = "[🔵⚫|𝗘𝘀𝘁𝗲𝗶𝘃𝗲𝗿𝘅𝗲 𝗟𝗼𝗺𝗶𝗻𝗼𝘂𝘀 𝗜𝗜 ]"; // changing this wont change the goatbot V2 of list cmd it is just a decoyy
...
░░░░░█░ █▀█ █▄ █░█ ░█░░░░\n\n◦❭❯❱ 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 & 𝗖𝗔𝗧𝗘𝗚𝗢𝗥𝗬 ❰❮❬◦`; // replace with your name 
			...
			msg += `♥️ |𝐄𝐬𝐭𝐞𝐢𝐯𝐞𝐫𝐱𝐞 𝐋𝐨𝐦𝐢𝐧𝐨𝐮𝐬 𝐈𝐈`; // its not decoy so change it if you want 
